...
/// <summary>
/// Extensions to the System.Numerics Vector3 class
/// </summary>

public static class Vector3Extensions
{
    /// <summary>
    /// Gets the squared distance from this point to another, using the LengthSquared() method.
    /// </summary>
    /// <param name="v">This point</param>
    /// <param name="other">The other point</param>
    /// <returns>Squared distance from this point to the other point</returns>
    public static double SquareDistanceTo(this Vector3 v, Vector3 other)
    {
...
public class KDTree
{
    ...
    public int findNearest(Vector3 p, out double dist)
    {
    ...
    public bool findNearestLim(Vector3 p, double lim)
    {
        SearchContextBoolean sc = new SearchContextBoolean();
        sc.smDist = double.MaxValue;
        sc.smDistSq = double.MaxValue;
    ...
    public List<int> findAllCloserThan(Vector3 p, double lim)
    {
    ...
    internal double findSecondNearest(int i)
    {
        SearchContextBoolean2 sc = new SearchContextBoolean2();
        sc.smDist = double.MaxValue;
        sc.smDistSq = double.MaxValue;
        sc.nearest = -1;
        sc.p = pnts[i];
        sc.self = i;
        searchSubtreeX2(root, sc);
        return (sc.smDist);
    }
    ...
    void searchSubtreeX2(Node n, SearchContextBoolean2 sc)
    {
        double dif = sc.p.X - n.value;
        ...
        if (dif < 0)
        {
            ...
            if (n.left != null)
            {
                searchSubtreeY2(n.left, sc);
            }
            if (n.right != null)
            {
                if ((-dif) < sc.smDist)
                    searchSubtreeY2(n.right, sc);
            }
        }
        else
        {
    ...
    void searchSubtreeY2(Node n, SearchContextBoolean2 sc)
    {
        double dif = sc.p.Y - n.value;
        if (dif < 0)
        {
            ...
            if (n.left != null)
            {
                searchSubtreeZ2(n.left, sc);
            }
            if (n.right != null)
            {
                if ((-dif) < sc.smDist)
                    searchSubtreeZ2(n.right, sc);
            }
        }
        else
        {
    ...
    void searchSubtreeZ2(Node n, SearchContextBoolean2 sc)
    {
        double dif = sc.p.Z - n.value;
        if (dif < 0)
        {
            ...
            if (n.left != null)
            {
                searchSubtreeX2(n.left, sc);
            }
            if (n.right != null)
            {
                if ((-dif) < sc.smDist)
                    searchSubtreeX2(n.right, sc);
            }
        }
        else
        {
